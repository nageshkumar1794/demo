...
//		crp.casereport();
		...
		CollegeCourse course1 = new CollegeCourse("Math", 1600);
		CollegeCourse course2 = new CollegeCourse("Phys", 3200);

		ClassSection section1 = new ClassSection("Math", 3221, 201, "TTh 9:00-10:30");
